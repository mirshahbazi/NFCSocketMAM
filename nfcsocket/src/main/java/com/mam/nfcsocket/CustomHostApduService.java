...
public abstract class CustomHostApduService extends Service {
    ...
    /**
     * MSG_REFRESH_SERVER is sent by NfcReciveSocket when user start listening.
     * The messenger of NfcReciveSocket will be set in replyto attribute.
     */
     ...
     * {@link NfcReciveSocket} bind with {@link HCEService}, its local messenger
     * will be sent. <li> {@link NfcReciveSocket} unbind with {@link HCEService},
     * null will be sent.
     *
     * @param serverMessenger Either local messenger of {@link NfcReciveSocket} or null
     */
